-- rust priorization functions come from: https://github.com/ryo33/nvim-cmp-rust/tree/main commit #0c9fafd there's no license, just contact me if you don't want me to use your configs. if you add a license i will add to this file
-- i only changed uh... to make this work without vim.iter
